    ...
    const onChange = (name, value) => {
        ...
        if (
            ["type", "launcherIconBgColor", "launcherIcon", "launcherIconColor",
                ...
                "launcherBottomSpacing", "sidebarPosition", "popoverWidth", "popoverOffset", "popoverHeight"]
                .includes(name)
        ) {
                            ...
                            <div className={"flex gap-2"}>
                                {
                                    ...
                                    <div className={"space-y-4 w-1/2"}>
                                        <div className={"space-y-2"}>
                                            ...
                                            {
                                                type === "modal" &&
                                                <Input type={"number"} value={widgetsSetting.modalWidth} min={0}
                                                       onChange={(e) => onChange("modalWidth", e.target.value)}
                                                       className={"w-full"}/>
                                            }
                                            {
                                                type === "sidebar" &&
                                                <Input type={"number"} value={widgetsSetting.sidebarWidth} min={0}
                                ...
                                }
                                {
                                    ...
                                    <div className={"space-y-2 w-1/2"}>
                                        ...
                                        {
                                            type === "popover" &&
                                            <Input type={"number"} value={widgetsSetting.popoverHeight} min={0}
                ...
                <div className={"px-4 py-3 space-y-4 border-b"}>
                    ...
                    <ToggleGroup type="single" className={"justify-between gap-2"}
                        ...
                        <ToggleGroupItem value="ideas"
                                         className={`w-full px-[9px] h-8 text-[12px] ${selectedToggle === 'ideas' ? 'bg-muted' : ''}`}>Ideas</ToggleGroupItem>
