        ...
        <Fragment>
            ...
            <Card>
                <CardHeader className={"p-4 sm:p-6 gap-1 border-b flex flex-row flex-wrap justify-between items-center gap-y-2"}>
                    ...
                    <div className={"m-0"}>
                        <Button onClick={handleNewTopics} disabled={showNewTopics} className={"text-sm font-semibold"}><Plus size={16} className={"mr-1 text-[#f9fafb]"} />New Tags</Button>
                    </div>
                </CardHeader>
                <CardContent className={"p-0"}>
                    <div className={"grid grid-cols-1 overflow-auto whitespace-nowrap"}>
                        ...
                        {isLoading === false && topicLists.length === 0 && <div className={"flex flex-row justify-center py-[45px]"}>
