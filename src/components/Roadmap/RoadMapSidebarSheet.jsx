...
import {SheetContent, Sheet, SheetHeader} from "../ui/sheet";
...
const RoadMapSidebarSheet = ({ isOpen, onOpen, onClose , sheetType}) => {
        ...
        <Sheet open={isOpen} onOpenChange={isOpen ? onClose : onOpen}>
            <SheetContent className={"lg:max-w-[1101px] md:max-w-[720px] sm:max-w-[520px] p-0"}>
                <SheetHeader className={"px-[32px] py-[22px] border-b"}>
                    {
                        sheetType === "createNewRoadMapIdeas" ?
                            <div className={"flex justify-between items-center w-full"}>
                                <h2 className={"text-xl text-muted-foreground font-medium"}>Tell us your Idea!</h2>
